...
question("The estimate for seat share...",
  ...
  answer("is negative and statistically significant at the 95% confidence level when government experience is at its maximum.", correct = F),
  answer("does not turn statistically significant at the 95% confidence level."),
  answer("is statistically independent of government experience."),
