...
*Hint: The regression output is already stored in the object `model`. And the `margins` package may be very useful for this exercise*
...
*Hint: The regression output is already stored in the object `model`. The `predict` function may be very useful for this exercise.*
