...
```{r prepare-elig-vot, include=FALSE}
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(default_ui(url = "https://ilias.uni-mannheim.de/ilias.php?baseClass=ilObjSurveyGUI&ref_id=1097269&cmd=infoScreen"))
```
