...
Welcome back to the tutorial for week 14! It's the second to last tutorial and as always we will start with some knowledge questions to repeat the lecture. In the coding exercises you will look at the support for the European Union among the citizens of member-states. Good luck and have fun!
...
question("What is the general problem with causal inference for observational data?",
  ...
  answer("Observational data does not tell us which unit is form the treatment and the control group."),
...
Calculate the change in anti-authoritarian values for Romania between 2008-2010 and 1999-2004. Round to four digits after the decimal. 
...
```{r q5, echo = FALSE}
question_text("What is the change in anti-authoritarian values for Romania between 2008-2010 and 1999-2004. Round to four digits after the comma.",
