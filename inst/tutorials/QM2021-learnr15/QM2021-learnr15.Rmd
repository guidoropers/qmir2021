...
Now let's have a look at the Brexit referendum data again (the data is stored as `df_learnr15`). You will reproduce Table 2 from Hobolt (2016, p.1268). Note that, as always,   you need to load any packages you want to use. What is the mean age of females in the data set? Round to two decimals if necessary.
...
Now, let's calculate predicted probabilities. Calculate the predicted probability of voting
  ...
  What is the predicted probability to vote `Leave` for such voters? Round to two decimals.
...
Now, calculate predicted probabilities, this time for the lowest value of `EuropeanIdentity`, holding everything else at its
  means or medians. What is the predicted probabiliy for those individuals? Again, round to two decimals.
